...
def parse_args(args=None):
    ...
    parser.add_argument('--sent_threshold', type=float, default=0.7)
    ##++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
def main(model_args):
    ...
    # logging.info('Saving {} record results to {}'.format(thresh_res_data_frame.shape, thresh_dev_result_name))
    # logging.info('*' * 75)
    ##++++++++++++++++++++++++++++++++++++++++++++++++++++
